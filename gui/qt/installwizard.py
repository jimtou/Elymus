...
MSG_GENERATING_WAIT = _("Elymus is generating your addresses, please wait...")
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.setWindowTitle('Elymus  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
    ...
    def run_and_get_wallet(self):
        ...
        self.set_layout(vbox, title=_('Elymus wallet'))
        ...
        if self.storage.requires_split():
            self.hide()
            msg = _("The wallet '%s' contains multiple accounts, which are no longer supported since Elymus 2.7.\n\n"
    ...
    def init_network(self, network):
        message = _("Elymus communicates with remote servers to get "
                  "information about your transactions and addresses. The "
                  "servers all fulfill the same purpose only differing in "
                  "hardware. In most cases you simply want to let Elymus "
